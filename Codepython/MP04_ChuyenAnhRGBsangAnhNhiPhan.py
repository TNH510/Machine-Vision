...
#Thiet lap mot gia tri nguong de tinh gia tri cho anh nhi phan
nguong = 130
...
for x in range(width):
    for y in range(height):
        ...
        #Xac dinh gia tri nhi phan
        if (gray_luminance < nguong):
